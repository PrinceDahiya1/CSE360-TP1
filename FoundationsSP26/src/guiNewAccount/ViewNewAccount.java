 ...
 * @version 1.01 		2026-01-26 Added Alerts for Username related error messages
 *  
 */
...
public class ViewNewAccount {
	...
	*/
	...
	// Modification for Task 8: Label to display Username Validation related errors
	protected static Alert alertUserNameError = new Alert(AlertType.ERROR);
	...
	*/
	...
	private ViewNewAccount() {
		...
		// Modification for Task 8: Configuring the Username Alert properties
		alertUserNameError.setTitle("Invalid User Name");
		alertUserNameError.setHeaderText("Please fix the UserName");
		
		// Fix: Allow the dialog pane to be resizable for longer error messages
		alertUserNameError.setResizable(true);
