 ...
 * @version 1.01		2026-01-26 Added Labels for Admin Username related errors
 *  
 */
...
public class ViewFirstAdmin {
	...
	// Modification for Task 8: Label to display Admin Username Validation related errors
	...
	private ViewFirstAdmin() {
		...
		// Modification for Task 8: Configure the Admin Username related Errors Label
		setupLabelUI(label_UserNameError, "Arial", 18, width, Pos.CENTER, 0, 340);
