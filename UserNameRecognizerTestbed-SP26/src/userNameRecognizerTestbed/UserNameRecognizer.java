...
public class UserNameRecognizer {
	 ...
	 * @version 1.02		2026-01-26  Modified for HW1: Enforced alphabetic first requirement,
	 * 									added hyphen/underscore support and changed character limit
	 * 									to 32 in accordance with the UML Diagram.
	 * 
	 */
	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			switch (state) {
			case 0: 
				// Modified State 0 transition: The first character must be a Letter (A-Z, a-z).
			    // This implements the Task 6 requirement to prevent numeric-led usernames,
			    // enhancing security by enforcing a stricter naming convention.
			...
			case 1: 
				// Modified State 1 to include period, hyphen, and underscore
			...
			case 2: 
				// State 2 handles characters following a separator (., -, or _)
